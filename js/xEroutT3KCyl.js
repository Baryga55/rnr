...
$(document).ready(function () {
    ...
    }),a.on("click", ".logthemes__item", function (e) {
        e.preventDefault(), $(".logthemes__item").removeClass("active"), $(this).addClass("active");
        var t = $(this).data("sa-value");
        a.attr("data-sa-theme", t)
    ...
    }), a.on("click", ".navigation__sub > a:not(.noprevent)", function (e) {
